...
colnames(table_s2) = c("BICLS_MSE", "ICLS_MSE", "ratio", "OLS_MSE", "ratio", "BICLS_var", "ICLS_var", "ratio", "OLS_var", "ratio")
...
write.csv(table_s2, file = paste0("./data_BICGLM/table_s2_", sample_size, "_", nu_0 / 2, ".csv"), fileEncoding = "UTF-8")
# write.csv(table_s1, file = paste0("./data_BICGLM/table_s1_", sample_size, "_", nu_0 / 2, ".csv"), fileEncoding= "UTF-8")
save(list = ls(all.names=TRUE), file = paste0("./data_BICGLM/A1_", sample_size, "_", nu_0 / 2, ".Rdata"))
