...
# ggsave(plot1, filename="./fig_BICGLM/fig1_beta1.png", width = 3.5, height = 7)
# ggsave(plot2, filename="./fig_BICGLM/fig1_beta2.png", width = 3.5, height = 7)
# ggsave(plot3, filename="./fig_BICGLM/fig1_beta3.png", width = 3.5, height = 7)
ggsave(fig_1, filename="./fig_BICGLM/fig1.png", width = 10.5, height = 7)

write.csv(table_1, file = paste0("./data_BICGLM/table_1_", sample_size, ".csv"), fileEncoding = "UTF-8")
write.csv(table_s1, file = paste0("./data_BICGLM/table_s1_", sample_size, ".csv"), fileEncoding= "UTF-8")
save(list = ls(all.names=TRUE), file = paste0("./data_BICGLM/A1_", sample_size, ".Rdata"))