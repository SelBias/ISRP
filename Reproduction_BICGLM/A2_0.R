...
ggsave(fig_2, filename=paste0("./fig_BICGLM/fig2_rho_", rho, ".png"), width = 6, height = 7)
write.csv(table_2, file = paste0("./data_BICGLM/table_2_rho_", rho, ".csv"), fileEncoding = "UTF-8")
save(list = ls(all.names=TRUE), file = paste0("./data_BICGLM/A2_rho_", rho, ".Rdata"))
