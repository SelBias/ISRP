...
ggsave(fig_s3, filename="./fig_BICGLM/fig_s3.png", width = 12, height = 16)

write.csv(table_4, file = "./data_BICGLM/table_4.csv", fileEncoding = "UTF-8")
write.csv(table_s4, file = paste0("./data_BICGLM/table_s4.csv"), fileEncoding= "UTF-8")
