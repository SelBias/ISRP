...
ggsave(plot0, filename="./fig/fig_s2_beta0.png", width = 6, height = 4)
ggsave(plot1, filename="./fig/fig_s2_beta1.png", width = 6, height = 4)
ggsave(plot2, filename="./fig/fig_s2_beta2.png", width = 6, height = 4)
ggsave(plot3, filename="./fig/fig_s2_beta3.png", width = 6, height = 4)
ggsave(fig_s2, filename="./fig/fig_s2.png", width = 12, height = 8)

write.csv(table_3, file = "./data/table_3.csv", fileEncoding = "UTF-8")
write.csv(table_s3, file = paste0("./data/table_s3.csv"), fileEncoding= "UTF-8")
