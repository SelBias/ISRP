...
write.csv(table_s2, file = paste0("./data/table_s2_", sample_size, "_", nu_0 / 2, ".csv"), fileEncoding = "UTF-8")
# write.csv(table_s1, file = paste0("./data/table_s1_", sample_size, "_", nu_0 / 2, ".csv"), fileEncoding= "UTF-8")
save(list = ls(all.names=TRUE), file = paste0("./data/A1_", sample_size, "_", nu_0 / 2, ".Rdata"))
